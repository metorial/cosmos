...
# Setup logging
LOG_FILE="/var/log/nomad-server-setup.log"
exec > >(tee -a "$LOG_FILE")
exec 2>&1

echo "========================================="
echo "NOMAD SERVER SETUP STARTED"
...
# Main Setup
log_section "NOMAD SERVER SETUP"
...
log_section "NOMAD SERVER SETUP COMPLETE"
log_info "Nomad server is running and ready"
